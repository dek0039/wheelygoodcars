                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link text-light" href="">Alle auto's</a></li>
                            @auth
                                <li class="nav-item"><a class="nav-link text-light" href="{{ route("mycars") }}">Mijn aanbod</a></li>
                                <li class="nav-item"><a class="nav-link text-light" href="{{ route("kenteken") }}">Aanbod plaatsen</a></li>
                            @endauth
                        </li>
                    </ul>
                    <ul class="navbar-nav">
